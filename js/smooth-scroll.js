	 ...
	 */
				var updateURL = function (anchor, isNum, options) {
								...
								history.pushState({
												...
												anchor: anchor.id
								}, document.title, anchor === document.documentElement
												? '#top'
												: '#' + anchor.id);
	 ...
	 */
		 ...
		 */
								smoothScroll.animateScroll = function (anchor, toggle, options) {
												...
												var endLocation = isNum
																...
																: getEndLocation(anchorElem, headerHeight, parseInt((typeof animateSettings.offset === 'function'
																				...
																				: animateSettings.offset), 10), animateSettings.clip); // Location to scroll to
			 ...
			 */
												var stopAnimateScroll = function (position, endLocation) {
																...
																// Check if the end location has been reached yet (or we've hit the end of the
																// document)
		 ...
		 */
								var clickHandler = function (event) {
												...
												// Check if event.target has closest() method By @totegi -
												// https://github.com/cferdinandi/smooth-scroll/pull/401/
												...
												var anchor = settings.topOnEmptyHash && hash === '#'
																? document.documentElement
																: document.querySelector(hash);
												anchor = !anchor && hash === '#top'
																? document.documentElement
																: anchor;
		 ...
		 */
								var popstateHandler = function (event) {
												// Stop if history.state doesn't exist (ex. if clicking on a broken anchor
												// link). fixes `Cannot read property 'smoothScroll' of null` error getting
												// thrown.
		 ...
		 */
								smoothScroll.init = function (options) {
												...
												// feature test
												if (!supports()) 
																throw 'Smooth Scroll: This browser does not support the required JavaScript methods and' +
																				' browser APIs.';
